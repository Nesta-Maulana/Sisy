                                    ...
                                    <tbody id="">
                                        ...
                                        @foreach ($draft_schedules as $draft_schedule)
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-toggle="modal" data-target="#prosesWoModal" onclick="setUpdateDataWo('draft','{{ app('App\Http\Controllers\ResourceController')->encrypt($draft_schedule->id) }}')" class="text-primary"><i class="fas fa-edit"></i></a> &nbsp;|&nbsp; 
