										...
										<div class="card-footer" style="padding:0px ">
											<div class="row no-gutters">
												...
												<div class="col-lg-12 col-md-12 col-sm-12 col-12 @if (is_null($energyMonitoringToday))
													...
													<button class="btn btn-outline-primary form-control" type="button"  onclick="editMonitoringData('{{ app('App\Http\Controllers\ResourceController')->encrypt($flowmeter->id) }}')">
