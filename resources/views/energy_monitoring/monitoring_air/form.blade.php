			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="card ">
					<div class="card-header bg-dark">
						Lokasi Pengamatan - {{ $flowmeters[0]->flowmeterLocation->flowmeter_location }}
					</div>
					<div class="card-body">
						@php
							$row = 0;
						...
						<div class="row">
							@foreach ($flowmeters as $flowmeter)
								<div class="col-lg-6 col-md-6 col-sm-6" style="padding: 3px;">
									<div class="card">
										<div class="card-header bg-white">{{ $flowmeter->flowmeter_name }}
										</div>
											...
											<div class="form-group mt-2">
												<div class="input-group mb-3">
												  	...
												  	<div class="input-group-append">
												    	<button class="btn btn-outline-light" type="button" id="button_save_{{ app('App\Http\Controllers\ResourceController')->encrypt($flowmeter->id) }}">
												    		<i style="font-size: 25px;" class="fas fa-clipboard-check" id="icon_{{ app('App\Http\Controllers\ResourceController')->encrypt($flowmeter->id) }}"></i>
												    	</button>
