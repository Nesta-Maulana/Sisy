        ...
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <form action="tambah-batch-proses" method="post">
                    ...
                    <input type="hidden" name="rpd_filling_head_id" value="<?php echo e(app('App\Http\Controllers\ResourceController')->encrypt($rpdFillingHead->id)); ?>">
                    <div class="row">
...
<?php /**PATH C:\xampp\htdocs\Sisy\resources\views/rollie/rpd_filling/pop-up/tambah-batch.blade.php ENDPATH**/ ?>