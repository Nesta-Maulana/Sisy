        ...
        <div class="modal-content ">
            ...
            <form action="tambah-batch-proses" method="post">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="cpp_head_id" value="<?php echo e(app('App\Http\Controllers\ResourceController')->encrypt($cppHead->id)); ?>">
...
</div><?php /**PATH C:\xampp\htdocs\Sisy\resources\views/rollie/cpp_produk/pop-up/tambah-batch.blade.php ENDPATH**/ ?>