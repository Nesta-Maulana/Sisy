...
<?php $__env->startSection('active-master-app-show-home'); ?> 
    active 
<?php $__env->stopSection(); ?>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group text-center">
                            ...
                            <h1 class="text-primary d-flex justify-content-center wow fadeInDown animated"> Aplikasi <?php echo e($menus[0]->application->application_name); ?></h1>    
                        </div>
                    </div>
                </div>
                <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sisy\resources\views/master_app/home.blade.php ENDPATH**/ ?>