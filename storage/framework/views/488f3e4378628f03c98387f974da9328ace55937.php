    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="user_id_inputer" id="user_id_inputer" value="">
                ...
                <div id="parameter-analisa" class="mt-4" style="border-bottom: 1px solid black; padding-bottom: 1rem;">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8">
                            <select onchange="status_akhir_at_event($('#sampel_at_event_kode').val())" name="hasil_ls_sa_sealing_quality" id="hasil_ls_sa_sealing_quality_event" class="select form-control"  required="true">
...
<?php /**PATH C:\xampp\htdocs\Sisy\resources\views/rollie/rpd_filling/pop-up/analisa-sampel-at-event.blade.php ENDPATH**/ ?>