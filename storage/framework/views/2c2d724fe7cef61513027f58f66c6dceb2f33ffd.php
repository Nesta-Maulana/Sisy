                        ...
                        <div class="row" id="nomor_wo_sampel_div">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-7">
                                <select name="nomor_wo_sampel" id="nomor_wo_sampel" class="select form-control"  required="true" >
                                    ...
                                    <?php if(count($rpdFillingHead->rpdFillingDetailPis) == 0): ?>
                                        <?php $__currentLoopData = $rpdFillingHead->woNumbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wo_number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                            <option value="<?php echo e(app('App\Http\Controllers\ResourceController')->encrypt($wo_number->id)); ?>" <?php if($wo_number->id === $rpdFillingHead->woNumbers[$hitungbatch-1]->id): ?>
                                                selected
                                            <?php endif; ?>>Batch Ke <?php echo e($batchke); ?> - <?php echo e($wo_number->wo_number); ?></option>
                                        <?php $batchke++; ?> 
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                        
                                    <?php else: ?>
                                        <?php $__currentLoopData = $rpdFillingHead->woNumbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wo_number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                            <option value="<?php echo e(app('App\Http\Controllers\ResourceController')->encrypt($wo_number->id)); ?>" 
                                            <?php if($wo_number->id === $rpdFillingHead->woNumbers[$hitungbatch-1]->id): ?>
                                                selected
                                            <?php endif; ?>>
                                                Batch Ke <?php echo e($batchke); ?> - <?php echo e($wo_number->wo_number); ?></option>
                                            <?php $batchke++; ?> 
                        ...
                        <div class="row mt-2" id="mesin_filling_sampel_div">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-7">
                                <select name="mesin_filling_sampel" id="mesin_filling_sampel" class="select form-control" style="padding: 0 .8rem;" required="true" onchange="getFillingSampel();">
                                    <?php if($rpdFillingHead->woNumbers[0]->product->fillingMachineGroupHead->filling_machine_group_name == 'Prisma'): ?>
                                        <?php $__currentLoopData = $rpdFillingHead->woNumbers[0]->product->fillingMachineGroupHead->fillingMachineGroupDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fillingMachineGroupDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="cek" selected disabled>Pilih Mesin Filling</option>
                                            <option value="<?php echo e(app('App\Http\Controllers\ResourceController')->encrypt($fillingMachineGroupDetail->fillingMachine->id)); ?>"><?php echo e($fillingMachineGroupDetail->fillingMachine->filling_machine_code); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
...
</div><?php /**PATH C:\xampp\htdocs\Sisy\resources\views/rollie/rpd_filling/pop-up/tambah-sampel.blade.php ENDPATH**/ ?>