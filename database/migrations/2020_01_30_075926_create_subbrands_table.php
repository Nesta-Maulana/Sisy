...
class CreateSubbrandsTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('master_data')->create('subbrands', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('brand_id')->comment('connect to brands table ');
            $table->char('subbrand_name');
    ...
    {
        Schema::connection('master_data')->dropIfExists('subbrands');
    }
}
