...
class CreateDepartementsTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('master_data')->create('departements', function (Blueprint $table) 
        {
            $table->bigIncrements('id');
            $table->char('departement',100);
    ...
    {
        Schema::connection('master_data')->dropIfExists('departements');
    }
}
