...
class CreatePlansTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('master_data')->create('plans', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('company_id')->comment('connected to companies table');
    ...
    {
        Schema::connection('master_data')->dropIfExists('plans');
    }
}
